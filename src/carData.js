...
export const manus = cars.map((val) => val.brand);
export const getModels = (manu) => {
  return cars.find((val) => val.brand === manu);
};
export const fuels = ["Diesel", "Gaoline", "CNG", "TNG", "Electric", "Hybrid"];

export const gears = ["Manuel", "Automatic"];

export const drive = ["Front", "Back", "4x4"];
...
export const doorNumber = ["2/3", "4/5"];

export const seatsNumber = ["2", "3", "4", "5", "6", "7", "8"];

export const side = ["Left", "Right"];

export const ac = ["No AC", "Manuel AC", "Automatic AC"];
...
export const interiorColor = ["Black", "Brown", "Beige", "Gray", "Other"];

export const damage = [
  "No damage",
  "Damaged (driving condition)",
  "Damaged (no driving condition)",
];

export const origin = ["Local plates", "Foreign plates", "Buyer name"];

export const change = ["Yes", "No"];
